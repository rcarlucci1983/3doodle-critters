    ...
    def publish_to_github(self):
        ...
        try:
            ...
            messagebox.showinfo(
                ...
                "Visit: https://rcarlucci1983.github.io/3doodle-critters\n\n"
...
<head>
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        header {{ background: linear-gradient(135deg, var(--pink) 0%, var(--purple) 50%, var(--teal) 100%); padding: 2rem 1rem; text-align: center; }}
        ...
        .contact-box {{ background: linear-gradient(135deg, var(--purple) 0%, var(--teal) 100%); border-radius: 20px; padding: 3rem; text-align: center; color: white; }}
